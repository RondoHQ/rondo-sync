...
const PIPELINE_CONFIG = {
  ...
  sponsit: { displayName: 'Sponsit', description: 'Sponsor contacts from Sponsit to the local review mirror', manualNote: 'Read-only import; Rondo writes are disabled pending review' },
  freescout: { displayName: 'FreeScout', description: 'Member data from Sportlink to FreeScout customers', sourceSportlink: true },
