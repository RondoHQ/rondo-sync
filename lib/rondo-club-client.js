...
/** Report the verified outcome of self-service fields to Rondo's audit log. */
async function notifyProfileChangeStatus(personId, fields, status, error = '', options = {}) {
  return rondoClubRequestWithRetry(
    'rondo/v1/profile-change-log/sync-status',
    'POST',
    {
