...
function initDb(db) {
  ...
  const addressFields = ['street_name', 'house_number', 'house_number_addition', 'postal_code', 'city', 'country'];
...
function getUnsyncedChanges(db) {
  const stmt = db.prepare(`
    ...
    WHERE field_name IN (
      ...
      'street_name', 'house_number', 'house_number_addition', 'postal_code', 'city', 'country'
    )
      AND synced_at IS NULL
